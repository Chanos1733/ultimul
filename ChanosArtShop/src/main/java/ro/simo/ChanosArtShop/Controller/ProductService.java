...
public class ProductService {
    ...
    public String editProduct( Integer id,String name, double price, String materials, String dimensions, String color , String description, String photo1, String photo2,
                              String photo3) {
        //validam datele de intrare
        if (description.length() < 5) {
            return "Introduceti o lungime mai mare de 5 caractere in descriere!";
        ...
        return "Produsul a fost modificat in baza de date!";
    }
}
